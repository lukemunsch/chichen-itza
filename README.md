...
this to make a narrower space for my content, but due to complications with images not 
performing the way they should and being unable to understand the responsive code 
